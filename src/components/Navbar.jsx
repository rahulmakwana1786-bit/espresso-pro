...
export default function Navbar() {
  ...
  return (
    ...
    >
      {/* White Pill Navbar */}
      <div className="pointer-events-auto bg-white/95 backdrop-blur-md rounded-full px-5 py-3 md:px-8 md:py-4 flex items-center justify-between w-full max-w-[1200px] shadow-[0_15px_50px_rgba(0,0,0,0.5)]">
