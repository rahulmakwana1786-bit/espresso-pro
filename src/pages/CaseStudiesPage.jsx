...
export default function CaseStudiesPage() {
  ...
  return (
    ...
    >
      {/* ================= DECORATIVE TOP WAVES (Matches Services Page) ================= */}
      <div className="absolute top-0 left-0 w-full h-[50vh] md:h-[60vh] pointer-events-none z-0 mix-blend-multiply [mask-image:linear-gradient(to_bottom,black_0%,transparent_100%)] overflow-hidden">
        ...
        >
          ...
          <motion.div 
            ...
            className="absolute top-[0%] left-[-5%] w-[40%] h-[80%] bg-[#1a2f4c] rounded-[100%] blur-[90px] opacity-90" 
          />
          ...
          <motion.div 
            ...
            className="absolute top-[20%] left-[25%] w-[40%] h-[70%] bg-[#cca027] rounded-[100%] blur-[90px] opacity-85" 
          />
          ...
          <motion.div 
            animate={{ y: ["-10%", "10%", "-10%"] }}
            transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
            className="absolute top-[0%] left-[45%] w-[40%] h-[80%] bg-[#1a2f4c] rounded-[100%] blur-[90px] opacity-90" 
          />
          ...
          <motion.div 
            animate={{ y: ["10%", "-10%", "10%"] }}
            transition={{ duration: 9, repeat: Infinity, ease: "easeInOut" }}
            className="absolute top-[20%] left-[75%] w-[40%] h-[70%] bg-[#cca027] rounded-[100%] blur-[90px] opacity-85" 
          />
        </motion.div>
