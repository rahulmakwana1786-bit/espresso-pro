...
export default function Work() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#fbf8f3] text-[#291b03] pt-[180px] md:pt-[240px] pb-20 px-6 md:px-12 lg:px-20 xl:px-32 relative overflow-clip">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#B8734E]/5 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#8a563a]/5 rounded-full blur-[120px] pointer-events-none" />
...
function CarouselCard({ item, idx, worksLength, scrollYProgress, containerRef, navigate }) {
  ...
  return (
    ...
    >
      {/* Card Container */}
      <div className="relative w-full aspect-[4/3] lg:aspect-[16/10] rounded-[28px] overflow-hidden border border-[#C08860]/10 bg-[#0c0806] flex items-center justify-center transition-shadow duration-500 hover:border-[#B8734E]/30 hover:shadow-[0_0_50px_rgba(184,115,78,0.1)] group">
        <div className="absolute inset-0 bg-gradient-to-tr from-[#B8734E]/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10" />
        <img
          src={item.image}
          alt={item.title}
